...
class Post(models.Model):
    ...
    author = models.ForeignKey(User, null=True, verbose_name='autor', on_delete=models.SET_NULL)
    thumbnail = models.ImageField(upload_to='uploads', verbose_name='imagem destacada', blank=True, null=True)
    ...
    created_at = models.DateTimeField(null=True, verbose_name='criado em', auto_now_add=True)
    updated_at = models.DateTimeField(null=True, verbose_name='atualizado em', auto_now=True)
